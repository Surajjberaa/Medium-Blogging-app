    ...
    <div >
        ...
        <div className="flex justify-center h-screen bg-gray-50">
            <div className="max-w-screen-lg w-full pt-8 px-5">
                ...
                <textarea id="message" rows={1} required onChange={(e)=>{
                 ...
                 <div>
                    <div className=" py-4  bg-gray-50  rounded-b-lg">
                        <textarea id="editor" required rows={8} onChange={(e)=>{
                            setContent(e.target.value)
                        }
                        } className="block focus:outline-none  bg-gray-50 font-serif w-full px-0 text-lg text-gray-800 pl-4 rounded-lg focus:ring-0" placeholder="Tell your story..." ></textarea>
                    </div>
                 </div>
                <div>
                ...
                <div className="mt-4 w-10/12 lg:w-4/12">
                    {alert == true ? <Alert desc="Please share your story first" onclick={removeAlert} />: null}
                </div>
